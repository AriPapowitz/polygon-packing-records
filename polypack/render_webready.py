...
def main(argv=None):
    ...
    ap.add_argument("solution", help="packing solution JSON")
    ap.add_argument("sample_gif", help="incumbent image to learn the page style from")
    ap.add_argument("out", help="output GIF path")
    args = ap.parse_args(argv)
    print(render(args.solution, args.sample_gif, args.out))
