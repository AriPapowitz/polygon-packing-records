...
| 3 | closed-form | harvest that landed on a value agreeing with an exact algebraic form the incumbent missed |
...
5. **Provenance.** Claimed values and coordinates: batch emails + coordinate
